                    ...
                    <div class="card">
                        ...
                        <div class="card-body px-5">
                            ...
                            <div class="container text-center">
                                <img src="img/sign-up.png" style="max-width: 100px;" class="img-fluid">
                            </div>
                            ...
                            <form action="RegisterServlet" method="post">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="user_address" style="height:60px" class="form-control" placeholder="Enter your address"></textarea>
                                </div>

                                <div class="container text-center">
                                    <button class="btn custom-bg">Register</button>
                                    <button class="btn custom-bg">Reset</button>
                                </div>
                            </form>
